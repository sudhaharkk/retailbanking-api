...
import com.retail.api.component.AppData;
...
public class RetailServiceImpl implements IRetailService {
	...
	private final Logger log = LoggerFactory.getLogger(RetailServiceImpl.class);

	AppData appData;

	public RetailServiceImpl(AppData appData) {
		super();
